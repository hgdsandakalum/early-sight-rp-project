...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-[9999] flex h-screen w-72 flex-col overflow-y-hidden bg-[#f1f5f9] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/" && "bg-slate-900 bg-meta-4 text-white"
                  }`}
                  onClick={(e) => {
                    e.preventDefault();
