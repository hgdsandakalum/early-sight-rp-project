  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`absolute right-0 mt-4 flex w-[200px] flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
          dropdownOpen === true ? "block" : "hidden"
        }`}
      >
        <ul className="flex flex-col gap-4 border-b border-stroke px-6 py-7 ">
          <li>
            <Link
              href="/profile"
