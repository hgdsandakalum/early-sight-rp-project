...
const DetailedEyeResultTable = ({ columns }) => {
    ...
    try {
      ...
      if (response.status === 200) {
        const a = response?.data?.data?.map((item) => ({
          ...item,
          leftEye: item.overrollTestScore.leftEye,
          rightEye: item.overrollTestScore.rightEye,
        }));
        console.log(a);
        setData(a);
      }
...
export default DetailedEyeResultTable;
